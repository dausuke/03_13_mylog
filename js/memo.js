$(function () {
    ...
    $('.clear').on('click', function () {
        ...
        $('#listclear').text(clearname+'を消去しますか？')
        $('.modal').fadeIn();
        return false;
    });
    ...
    $('.modal-close').on('click', function () {
        ...
        const removename = $(this).parents('.modal').siblings('.listitem').find('.listkname').val();
        console.log(removename);
        localStorage.removeItem(removename);
        $(this).parents('.modal').siblings('.listitem').find('.listkname').val('');
        $(this).parents('.modal').siblings('.listitem').find('.listgetday').val('');
        $(this).parents('.modal').siblings('.listitem').find('.listkarea').val('');
        $(this).parents('.modal').siblings('.listitem').find('.listcategory').val('');
        $(this).parents('.modal').siblings('.listitem').find('.listpnumber').val('');
        $(this).parents('.modal').siblings('.listitem').find('.listevaluation').val('')
        $(this).parents('.modal').siblings('.listitem').find('.listfreetext').val('');
        $('.modal').fadeOut();
        return false;
    });
    //ページトップボタン
